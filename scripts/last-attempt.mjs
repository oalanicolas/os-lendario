...
const attempts = [
  ...
  {
    slug: 'dan_kennedy',
    url: 'https://www.nobsinnercircle.com/wp-content/uploads/2021/03/dan-kennedy.jpg',
  },
  {
    slug: 'adriano-de-marqui',
    url: 'https://scontent.cdninstagram.com/academialendaria_profile.jpg',
  },
];
