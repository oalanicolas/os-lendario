...
export const MOCK_PSYCHOMETRICS: Record<string, PsychometricProfile> = {
  alan_nicolas: {
    ...
    aptitudes: {
      superpowers: [
        'Visão de Raio-X de Sistemas',
        'Síntese de Modelos Complexos',
      ...
      zone_of_genius: {
        ...
        description:
          'Capacidade única de traduzir intuição abstrata em frameworks lógicos executáveis.',
      },
    },
    interaction_guide: {
      communication_style: {
  ...
  steve_jobs: {
    ...
    aptitudes: {
      ...
      zone_of_genius: {
        ...
        description:
          'Capacidade de ver o futuro e trazê-lo para o presente com perfeição estética.',
      },
    },
    interaction_guide: {
      communication_style: {
  ...
  mark_manson: {
    ...
    aptitudes: {
      superpowers: [
        'Traduzir Complexidade em Simplicidade Vulgar',
        'Storytelling Irreverente',
        'Psicologia Prática',
      ],
      ...
      zone_of_genius: {
        title: 'Filósofo Pop',
        description:
          'Capacidade de tornar filosofia acessível através de linguagem direta e humor.',
      },
    },
    interaction_guide: {
      communication_style: {
  ...
  elon_musk: {
    ...
    aptitudes: {
      superpowers: [
        'Pensamento de Primeiros Princípios',
        'Capacidade de Execução Massiva',
