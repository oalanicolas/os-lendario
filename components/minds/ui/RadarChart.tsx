            ...
            <div className="relative" style={{ width: size, height: size }}>
                ...
                <svg viewBox={`0 0 ${size} ${size}`} className="w-full h-full overflow-visible">
                    ...
                    <polygon
                        ...
                        strokeWidth="2"
                        className="drop-shadow-[0_0_10px_rgba(var(--primary-rgb),0.5)] animate-pulse-slow"
                    />
                    ...
                    {showLabels && data.map((d, i) => {
                        ...
                        return (
                            <text
                                ...
                                className={`text-[10px] uppercase font-mono tracking-wider font-bold ${colors.text}`}
                                style={{
