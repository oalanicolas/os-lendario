...
export const MindEditDialog: React.FC<MindEditDialogProps> = ({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[600px] bg-[#0F0F13] border-white/10 text-white">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">
                        <Icon name="settings" className="text-brand-gold" />
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 py-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2 col-span-2">
                            ...
                            <Input
                                ...
                                className="bg-zinc-900/50 border-white/10 focus:border-brand-gold/50"
                            />
                        </div>
                    ...
                    <DialogFooter>
                        ...
                        <Button
                            ...
                            disabled={loading}
                        >
                            {loading ? <Icon name="spinner" className="animate-spin mr-2" /> : <Icon name="save" className="mr-2" />}
                            Salvar Alterações
                        </Button>
                    </DialogFooter>
                </form>
