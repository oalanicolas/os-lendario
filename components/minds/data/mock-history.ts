...
export const MOCK_HISTORY_DATA: HistoryEvent[] = [
  // === ANTES DE 2014 ===
  {
    ...
    description: 'Cresceu em um bairro pobre e perigoso da grande Porto Alegre. Infancia marcada por dificuldades financeiras, incluindo cortes de energia e agua.',
    details: [
  ...
  },
  {
    ...
    description: 'Treinou 14 meses para servir na Forca Aerea, mas foi reprovado. O oficial que o reprovou o aconselhou a seguir outro caminho.',
    details: [
  ...
  },
  {
    ...
    description: 'Multiplas experiencias profissionais: cabo man, iluminador, cinegrafista, professor de piano e violao, manutencao de computadores, vendedor.',
    details: [
  ...
  },
  {
    ...
    description: 'Aos 21 anos, conheceu um mentor que havia criado uma multinacional. Convidado para abrir empresa de delivery online, mas o projeto nao foi adiante.',
    details: [
  ...
  },
  {
    ...
    description: 'Evento de JavaScript em Porto Alegre expoe a barreira do idioma. Nao consegue entender as palestras nem um video comico com uma colega.',
    details: [
  ...
  // === 2014 - O ANO DA VIRADA ===
  {
    ...
    description: 'Leitura do livro de Tim Ferriss causa impacto profundo na mentalidade sobre trabalho e dinheiro. Dispara leitura de 128 livros no ano seguinte.',
    details: [
  ...
  // === 2015 ===
  {
    ...
    description: 'Mudanca para Florianopolis marca inicio da jornada de desenvolvimento pessoal e entrada no marketing digital.',
    details: [
  ...
  // === 2016 ===
  {
    ...
    description: 'Declara para sua mae que ja e milionario, antecipando uma conquista que ainda nao havia materializado.',
    details: [
  ...
  // === 2017 ===
  {
    ...
    description: 'Torna-se referencia nacional em funis de alta conversao. Ajuda clientes a recuperarem mais de R$10 milhoes em vendas perdidas.',
    details: [
  ...
  // === 2018 ===
  {
    ...
    description: '1 ano e 4 meses apos a declaracao a mae, atinge a marca de 1 milhao de reais na conta bancaria.',
    details: [
  ...
  // === 2019 ===
  {
    ...
    description: 'Conquista independencia financeira antes dos 30 anos. Compra casa propria em bairro nobre.',
    details: [
  ...
  },
  {
    ...
    description: 'Apos conquistar objetivos materiais, enfrenta vazio existencial. Dezembro marca reflexao profunda e decisao de compartilhar a jornada.',
    details: [
  ...
  // === 2020 ===
  {
    ...
    description: 'Inicio do projeto focado em inspirar e ajudar outras pessoas. Aprofundamento em estudos sobre mente humana, proposito e valores.',
    details: [
  ...
  // === 2021 ===
  {
    ...
    description: 'Deixa sociedade em uma das maiores empresas de marketing direto do Brasil para focar em projetos pessoais.',
    details: [
  ...
  // === 2021-2023 ===
  {
    ...
    description: 'Afasta-se das redes sociais e producao de conteudo. Periodo de autoconhecimento, estudos aprofundados e enfrentamento de desafios internos.',
    details: [
  ...
  // === 2023 ===
  {
    ...
    description: 'Retorna ao Vida Lendaria com nova perspectiva. Grava "A Beira do Abismo" no dia do aniversario, compartilhando vulnerabilidades.',
    details: [
  ...
  },
  {
    ...
    description: 'Lancamento do curso para ensinar a criar um "segundo cerebro" potencializado com IA. Fusao de todas as experiencias anteriores.',
    details: [
...
export const PROFESSIONAL_ACHIEVEMENTS = [
  {
    ...
    description: 'Conhecido como "El Funileiro". Palestras pelo Brasil, consultorias que ajudaram clientes a recuperar mais de R$10 milhoes em vendas perdidas.'
  },
  {
    title: 'Fundador de Empresa Lider em Marketing Direto',
    period: '2015 - 2021',
    description: 'Co-fundou e atuou como CEO de uma das empresas mais premiadas do Brasil na area, faturando multiplos 7 digitos.'
  },
  {
    title: 'Independencia Financeira',
    period: '2019',
    description: 'Alcancou independencia financeira antes dos 30 anos, permitindo foco em projetos alinhados com proposito.'
  },
  {
    title: 'Palestrante Internacional',
    period: '2015-2019',
    description: 'Palestras em eventos de marketing digital pelo Brasil. Convidado para eventos internacionais. Livro autografado da InfusionSoft.'
  },
  {
    title: '500+ Livros Lidos',
    period: 'Desde 2014',
    description: 'Leitura assiduada incluindo Trabalhe 4h por Semana, O Poder do Habito, Antifragil, Essencialismo e centenas de outros.'
  },
  {
    title: 'Criador do Vida Lendaria e Mente Lendaria',
    period: '2020 - Presente',
    description: 'Podcast e curso para ajudar pessoas a viverem com mais significado, proposito e realizacao.'
  }
];
