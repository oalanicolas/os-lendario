...
export const MOCK_COMMUNICATION_DATA = {
  voiceDNA: {
    ...
    keywords: ["Lendário", "AI First", "Escalar", "Legado", "F*da-se o medíocre", "Engrenagem", "Orquestração"]
  },
  // O Sistema Operacional Comportamental
  behavioralOS: {
    traits: [
      { name: "Energy Cycles", value: "Non-Linear", desc: "Picos de Hiperfoco (8h+) vs Vales de Recuperação. Não espere consistência 9-5.", icon: "activity" },
      { name: "Redundancy Allergy", value: "Critical", desc: "Rejeição imediata de inputs repetitivos. Interações devem avançar em Profundidade ou Precisão.", icon: "alert-triangle", color: "text-red-500" },
      { name: "Clarity First", value: "Absolute", desc: "Alinhamento Interno > Dados Externos. 'Se há dúvida, é não'.", icon: "search" },
      { name: "Selective Procrastination", value: "Filter", desc: "Adia tarefas desalinhadas como sinal de defesa da 'Zona de Genialidade'.", icon: "filter" }
    ],
  ...
  semantics: {
    tier1: {
      ...
      words: ["Clareza é uma arma", "A única constante é a mudança", "Conhece-te a ti mesmo", "Quando não somos autênticos, adoecemos", "Grave isso"]
    },
    tier2: {
      label: "Tier 2: Modelos Mentais (Frameworks)",
      words: ["Pareto ao Cubo", "Perdas limitadas, ganhos ilimitados", "Otimista Racional", "Do ponto de vista de sistemas...", "Elimina → Automatiza → Otimiza"]
    },
    tier3: {
      label: "Tier 3: Contextual (Situcional)",
      words: ["InnerLens", "Gaiola de ouro", "Morte e renascer", "Engenheiro vs Engrenagem", "Obeso intelectual"]
    }
  },
  ...
  catchphrases: [
    { text: "Você precisa ser mais lembrado do que ensinado.", tag: "Filosófica", desc: "Base pedagógica do método." },
    { text: "A vida é uma jornada que vence aqueles que aprenderem a morrer antes da morte.", tag: "Filosófica", desc: "Morte simbólica do eu medíocre." },
    { text: "Primeiro seja, para depois ter.", tag: "Princípio de Ação", desc: "Identidade antes de resultados." },
    { text: "O que vem fácil, vai fácil.", tag: "Princípio de Ação", desc: "Valor do esforço consistente." },
    { text: "Alimente o lobo certo!", tag: "Ferramenta de Escolha", desc: "Poder da atenção seletiva." },
    ...
    { text: "Ninguém é vilão em suas próprias histórias.", tag: "Verdade Incômoda", desc: "Perspectiva e narrativa pessoal." },
    { text: "Estabilidade é o nome bonito da estagnação.", tag: "Verdade Incômoda", desc: "Destruição de ilusão básica." },
    { text: "Grave isso:", tag: "Comando Direto", desc: "Marca momentos de insight crucial." },
    { text: "Pessoas medíocres são menores que seus problemas.", tag: "Declaração de Poder", desc: "Reformulação brutal de conceito." }
  ],
  // A Matriz Contextual: Como a voz muda
  contextualMatrix: [
    { context: "Vendas (High Stakes)", shift: "Aumenta URGÊNCIA e POLARIZAÇÃO. Diminui complexidade.", tone: "Agressivo" },
    { context: "Ensino (Mentoria)", shift: "Aumenta ESTRUTURA e ANALOGIAS. Mantém autoridade.", tone: "Professoral" },
    { context: "Conflito (Crítica)", shift: "Frio, cínico, baseado em dados. Remove toda emoção.", tone: "Cirúrgico" },
    { context: "Storytelling (Origem)", shift: "Vulnerabilidade calculada. Jornada do Herói clássica.", tone: "Inspirador" }
  ],
  writingSamples: {
    twitter: {
      content: "A maioria das pessoas está brincando de casinha com IA.\n\nEnquanto você pede pro ChatGPT escrever e-mail, seu concorrente tá construindo um AGENTE que prospecta, qualifica e vende enquanto ele dorme.\n\nNão é sobre produtividade. É sobre SUBSTITUIÇÃO de ineficiência.\n\nOu você domina essa p*rra, ou vira estatística.\n\n#AIFirst #Lendario",
