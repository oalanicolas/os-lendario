...
const MenubarContent = ({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 absolute left-0 top-full z-50 min-w-[12rem] translate-y-1 overflow-hidden rounded-md border border-border bg-popover p-1 text-popover-foreground shadow-md',
        className
      )}
    >
      {children}
