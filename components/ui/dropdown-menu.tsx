...
>(({ className, children, align = "left", side = "bottom", ...props }, ref) => {
    ...
    let positionClasses = "absolute z-50 mt-2 w-56 rounded-md border border-border bg-popover p-1 shadow-md animate-accordion-down focus:outline-none";
    ...
    if (side === "right") {
        ...
        else if (align === "center") positionClasses = cn(positionClasses, "left-1/2 -translate-x-1/2");
...
>(({ className, inset, destructive, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors hover:bg-accent hover:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 font-sans",
      inset && "pl-8",
