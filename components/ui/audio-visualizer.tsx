        ...
        return (
          <div
            ...
            className={cn(
              ...
              state === 'speaking' && 'h-8 animate-[shimmer_0.5s_infinite_alternate]',
              state === 'processing' && 'h-1.5 w-1.5 animate-spin-slow rounded-sm'
            )}
            style={{
          ...
          >
            ...
            <div
              className={cn(
                ...
                state === 'speaking'
                  ? `animate-[visualizer-${i}_${0.4 + Math.random() * 0.2}s_ease-in-out_infinite]`
                  : ''
              )}
