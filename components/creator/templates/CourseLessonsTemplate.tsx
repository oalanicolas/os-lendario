...
const mockLessons: Lesson[] = [
    { id: "1.1", moduleId: 1, moduleName: "O Desafio do Engajamento", title: "Introdução ao Desafio", duration: "8 min", type: "video", status: "completed", gpsScore: 92, dlScore: 88, wordCount: 1250, lastUpdated: "09/12/2025" },
    { id: "1.2", moduleId: 1, moduleName: "O Desafio do Engajamento", title: "A Curva da Atenção", duration: "7 min", type: "video", status: "completed", gpsScore: 88, dlScore: 85, wordCount: 1100, lastUpdated: "09/12/2025" },
    { id: "1.3", moduleId: 1, moduleName: "O Desafio do Engajamento", title: "Erros Comuns", duration: "8 min", type: "video", status: "review", gpsScore: 75, dlScore: 72, wordCount: 1300, lastUpdated: "09/12/2025" },
    { id: "1.4", moduleId: 1, moduleName: "O Desafio do Engajamento", title: "Case de Sucesso", duration: "7 min", type: "video", status: "generating", lastUpdated: "09/12/2025" },
    { id: "2.1", moduleId: 2, moduleName: "Método GPS", title: "Destino Claro", duration: "10 min", type: "video", status: "draft", lastUpdated: "08/12/2025" },
    { id: "2.2", moduleId: 2, moduleName: "Método GPS", title: "Origem (Empatia)", duration: "8 min", type: "video", status: "draft", lastUpdated: "08/12/2025" },
    { id: "2.3", moduleId: 2, moduleName: "Método GPS", title: "Rota Otimizada", duration: "9 min", type: "video", status: "draft", lastUpdated: "08/12/2025" },
    { id: "2.4", moduleId: 2, moduleName: "Método GPS", title: "Workshop GPS", duration: "8 min", type: "practice", status: "draft", lastUpdated: "08/12/2025" },
    { id: "3.1", moduleId: 3, moduleName: "Didática para o Aluno Lendário", title: "Perfil do Aluno", duration: "10 min", type: "video", status: "draft", lastUpdated: "07/12/2025" },
    { id: "3.2", moduleId: 3, moduleName: "Didática para o Aluno Lendário", title: "Linguagem e Tom", duration: "8 min", type: "video", status: "draft", lastUpdated: "07/12/2025" },
];
...
const CourseLessonsTemplate: React.FC<CourseLessonsTemplateProps> = ({
    ...
    const getStatusBadge = (status: Lesson['status']) => {
        switch (status) {
            ...
            case 'review':
                return <Badge className="bg-brand-yellow/10 text-brand-yellow border-0 text-[10px]">Revisão</Badge>;
            case 'generating':
                return <Badge className="bg-primary/10 text-primary border-0 text-[10px] animate-pulse">Gerando...</Badge>;
            default:
    ...
    const getTypeIcon = (type: Lesson['type']) => {
        switch (type) {
            ...
            case 'practice': return 'laptop-code';
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="h-16 border-b border-border bg-card flex items-center justify-between px-6 shrink-0">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Gerencie e edite o conteúdo de cada lição</p>
                        </div>
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                <div className="w-8 h-8 rounded bg-muted/50 flex items-center justify-center">
                                                    <Icon name={getTypeIcon(lesson.type)} size="size-4" className="text-muted-foreground" />
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                            ...
                                            <TableCell className="text-center">
                                                <span className={cn("font-mono text-sm font-bold", getScoreColor(lesson.gpsScore))}>
                                                    {lesson.gpsScore || '-'}
                                                </span>
                                            </TableCell>
                                            <TableCell className="text-center">
                                                <span className={cn("font-mono text-sm font-bold", getScoreColor(lesson.dlScore))}>
                                                    {lesson.dlScore || '-'}
                                                </span>
                                            </TableCell>
                                            <TableCell>
