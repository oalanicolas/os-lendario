...
const OpsTopbar: React.FC<OpsTopbarProps> = ({ currentSection, setSection }) => {
  ...
  const navItems = [
    ...
    { label: 'Views', icon: 'table', section: Section.STUDIO_OPS_VIEWS, path: '/studio/ops/views' },
    {
      label: 'Schema',
      icon: 'sitemap',
      section: Section.STUDIO_OPS_SCHEMA,
      ...
      <div className="mx-auto flex h-full w-full max-w-[1600px] items-center justify-between px-6 md:px-12">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-[10px] text-muted-foreground">Infrastructure & Data</p>
          </div>
        </div>
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? 'bg-background shadow-sm' : 'hover:bg-[#64748B]/20',
