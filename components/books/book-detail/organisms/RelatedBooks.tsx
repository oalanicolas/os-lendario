  ...
  return (
    <>
      ...
      <section className="space-y-8">
        <div>
          <p className="text-xs font-bold uppercase tracking-wider text-primary">Recomendados</p>
          ...
          {books.map((related) => (
            ...
            >
              <div className="relative">
                {/* Aura */}
                <div className="absolute -inset-2 rounded-2xl bg-primary/0 opacity-0 blur-2xl transition-all duration-500 group-hover:bg-primary/15 group-hover:opacity-100" />
