...
export const STUDIO_SIDEBAR_CLASSES =
  'w-64 border-r border-border bg-card/50 flex flex-col shrink-0';

/** Classes padrão para header interno */
export const STUDIO_HEADER_CLASSES =
  'h-16 border-b border-border bg-card flex items-center justify-between px-6 shrink-0';
